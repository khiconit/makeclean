		...
		<div id="review_form_wrapper">
			<div id="review_form">
				<?php
					...
					$comment_form['comment_field'] .= '<p class="comment-form-comment"><label for="comment">' . __( 'Your Review', 'woocommerce' ) . '</label><textarea id="comment" name="comment" cols="150" rows="8" aria-required="true" class="form-control"></textarea></p>';
